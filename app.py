...
# ───────────────────────── НАВИГАЦИЯ ─────────────────────────
TASK_PAGES = [
    "Целесообразность ГКО",
    "Расход и давление нагнетания",
    "В.10 · Продавочная и вытесняющая жидкость",
    "В.15 · Изменение пористости",
    "В.16 · Эффективность ГКО",
]
...
# ───────────────────────── РОУТИНГ ЗАДАЧ ─────────────────────────
TASK_RENDERERS = {
    "Целесообразность ГКО":     task_v11.render,
    "Расход и давление нагнетания": task_v12.render,
    "В.10 · Продавочная и вытесняющая жидкость": task_v13.render,
    "В.15 · Изменение пористости":               task_v14.render,
    "В.16 · Эффективность ГКО":                   task_v15.render,
}
