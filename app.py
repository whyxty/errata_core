...
TASK_PAGES = [
    ...
    "Продавочная и вытесняющая жидкость",
...
TASK_RENDERERS = {
    ...
    "Продавочная и вытесняющая жидкость": task_v13.render,
    "Изменение пористости":               task_v14.render,
    "Эффективность ГКО":                   task_v15.render,
}
